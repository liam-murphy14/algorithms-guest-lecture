...
class TestKnightMoves(unittest.TestCase):
    ...
    def test_algorithms_match(self):
        ...
        for _ in range(1_000):
            start_x, start_y, end_x, end_y, bishop_x, bishop_y, n = self._get_test_case()
            with self.subTest(start_x=start_x, start_y=start_y, end_x=end_x, end_y=end_y, bishop_x=bishop_x, bishop_y=bishop_y, n=n):
